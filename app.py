...
def perguntar():
    ...
    try:
        ...
        instrucao_sistema = (
            ...
            "Evite falar sobre criminosos famosos, pode até dizer, mas informações não tão relevantes. Caso o usuario perguntar mais sobre, quero que recuse imediatamente"
        )
